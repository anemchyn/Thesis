...
The prototype will be implemented in Python and Django, using web scraping to gather price data from supermarket websites and PostgreSQL database to keep the data. Users can input a shopping list and specify a maximum travel distance or number of stores, after which the system calculates the most cost-effective shopping plan.
